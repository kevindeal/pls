...
if ( is_user_logged_in() ) {
    ...
    if (in_array('administrator', $current_user->roles)) {
        ...
        echo get_template_part('template-parts/blocks/userProfile/adminView');
    } else {
        // Default content or template part for other users
        get_template_part('template-parts/blocks/userProfile/publicView'); // Assuming it's in the same subdirectory
    }
} else {
