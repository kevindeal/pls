...
<div id="theTable">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <div class=" hidden flex items-center gap-x-3">
            ...
            <p class="hidden mt-1 hidden text-sm text-gray-500 dark:text-gray-300">These companies have purchased in the last 12 months.</p>
        </div>
        ...
        <div class="flex items-center mt-4 gap-x-3">
            ...
            <button class="hidden flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="px-auto py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    PLS ID
                                </th>
                            ...
                            <?php foreach ($subgroups as $subgroup): ?>
                                ...
                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                    <div>
                                        ...
                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400"><?php echo esc_html($subgroup['title']); ?></p>
                                    </div>
                                </td>
                                <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                    <div class="inline px-3 py-1 text-sm font-normal rounded-full text-emerald-500 gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                    <?php echo esc_html($subgroup['status']); ?>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                        <p class="text-gray-500 dark:text-gray-400">
                                            <?php echo esc_html($subgroup['location']['city']); ?>
                                        </p>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                        <p class="text-gray-500 dark:text-gray-400">
                                            <?php echo esc_html($subgroup['location']['state']); ?>
                                        </p>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                        <p class="text-gray-500 dark:text-gray-400">
                                            <?php echo esc_html($subgroup['pls_id']); ?>
                                        </p>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                        <p class="text-gray-500 dark:text-gray-400">
                                            <?php echo esc_html($subgroup['agency_type']); ?>
                                        </p>
                                    </div>
                                </td>
                            </tr>
