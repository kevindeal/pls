...
<div id="exampleHeader-container" class="w-full bg-white inline-flex p-4 pb-0">
        <div id="exampleHeader-content" class="w-full space-y-4">
            ...
            <div id="headerNavButtonGroup" class="w-full flex justify-between items-center">
                ...
                <button class="hover:scale-105 bg-white block float-right items-center text-black py-1 px-2 border-2 border-buttonBorderGray rounded-lg hover:bg-[#EFEFF1] hover:bg-opacity-25 transition-colors duration-150 text-sm">
                    <span class="material-symbols-outlined">
                        shopping_cart
                    </span>
                    <br />
            ...
            <div id="headerTitle" class="w-full inline-flex items-center space-x-4 relative">
            ...
            <?php
                if( $product_tags && ! is_wp_error( $product_tags ) ) {
                    ...
                    // Start of HTML block
                    echo '<div class="rounded-xl px-4 items-center flex h-7 bg-badgeLightBlue text-sm">';
                    echo '<p class="text-badgeDarkBlue">';
                    echo esc_html($tag->name); // Displaying the tag name
                    echo '</p>';
                    echo '</div>';
                    // End of HTML block
                }
