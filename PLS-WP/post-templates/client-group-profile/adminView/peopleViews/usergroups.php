...
<?php
    foreach ($nice_subgroups as $subgroup) : ?>
        <div id="list-item-closed" class="w-full my-2 align-middle rounded-xl bg-white inline-flex p-4 space-x-5 px-4 border-[#B9BBC0] border-2">
            ...
            <div id="list-item-button-group" class="w-full flex justify-end items-center space-x-3">
                <!-- Text Button -->
                <a href="patrol" class="bg-white text-black py-2 px-4 border-2 border-buttonBorderGray rounded-lg hover:bg-[#EFEFF1] hover:bg-opacity-25 transition-colors duration-150 text-sm">
